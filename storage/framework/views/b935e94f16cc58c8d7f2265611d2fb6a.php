...
<body>
  <header>
    ...
    <a href="<?php echo e(url('login')); ?>" class="button2">Iniciar sesión</a>
  ...
  <div class="presentacion">
    <div class="presentacion2">
      <img src="<?php echo e(asset('imagen/logo.png')); ?>" alt="Mi Logo" class="logo">
  ...
  <div class="presentacion">
    <div class="presentacion2">
      <img src="<?php echo e(asset('imagen/camion.png')); ?>" alt="Mi Logo" class="logo">
      <a class="button" href="<?php echo e(route('pedidos')); ?>"><?php echo e(__('realizar pedido')); ?></a>
      <h4 class="descripcion">
  ...
  <div class="presentacion">
    <div class="presentacion3">
      <img src="<?php echo e(asset('imagen/notas.png')); ?>" alt="Mi Logo" class="logo">
      <a class="button" href="<?php echo e(route('register')); ?>"><?php echo e(__('registrar')); ?></a>
...
<?php /**PATH C:\xampp\htdocs\appcarga\app\resources\views/welcome.blade.php ENDPATH**/ ?>